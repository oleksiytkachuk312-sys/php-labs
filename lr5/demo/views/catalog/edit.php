...
<h1>Редагувати товар #<?= (int)($product['id'] ?? 0) ?></h1>
...
<form method="POST" action="index.php?route=catalog/edit&id=<?= (int)($product['id'] ?? 0) ?>" class="form">
    ...
    <div class="form__group">
        ...
        <textarea id="prod_desc" name="description" class="form__textarea"><?= htmlspecialchars($product['description'] ?? '') ?></textarea>
    </div>
